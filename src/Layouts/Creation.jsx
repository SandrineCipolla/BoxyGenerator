  ...
  return (
    <div
      className="relative mt-20 w-[600px] h-[550px] border rounded-b
        rounded-tr border-purple-300 shadow-xl bg-gray-50 md:mt-0"
    >
        ...
        {tabsList.map((tab, index) => (
          <button
            ...
            className="min-w-[125px] py-2 px-3 mr-4 font-bold border-t border-x
                    border-purple-300 bg-gray-50 hover:bg-purple-200 texte-slate-700
      ...
      <div className="h-full overflow-auto max-h-[700]">
